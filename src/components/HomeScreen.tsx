...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  const categories = [
    ...
    { id: 'estetica', label: 'Massagem', icon: '💆' },
  ];
      ...
      <div className="px-5 pt-4 pb-2">
        ...
        <div className="mt-4 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-100 border-none rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
          />
        </div>
      </div>
      ...
      <div className="px-5 mt-2">
        ...
        {featuredOffer && (
          <div
            ...
            className="border-2 border-emerald-500/40 rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-md transition cursor-pointer group"
          >
            <div className="relative h-36 bg-slate-200 overflow-hidden">
              ...
              />
              <div className="absolute top-2.5 left-2.5 bg-white/95 backdrop-blur px-2.5 py-1 rounded-full text-[10px] font-bold text-slate-800 flex items-center gap-1 shadow-sm">
            ...
            <div className="p-3.5 space-y-2">
              ...
              <div className="pt-2 border-t border-slate-100 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold rounded-xl transition shadow-sm uppercase tracking-wide"
                >
                  RESERVAR
                </button>
              </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {offers.slice(1, 3).map((off) => (
            <div
              ...
              className="border border-slate-100 rounded-xl overflow-hidden bg-white hover:border-slate-300 transition cursor-pointer group"
            >
