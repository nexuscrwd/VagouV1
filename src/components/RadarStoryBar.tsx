    ...
    <div className="w-full py-2.5 px-4 overflow-x-auto no-scrollbar">
      <div className="flex items-center gap-3.5 min-w-max">
        ...
        <div className="flex flex-col items-center flex-shrink-0">
          ...
          <span className="text-[10px] font-black text-emerald-600 mt-1 uppercase tracking-tight font-['Poppins']">
            Ao Vivo
          </span>
        </div>
        ...
        {sortedStories.map((offer, index) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] font-semibold text-slate-300 group-hover:text-white mt-1.5 max-w-[62px] truncate text-center leading-tight font-['Poppins']">
                {offer.salonName}
              </span>
            </motion.button>
          );
